...
CREATE TABLE `__new_bookings` (
	...
	`created_at` text DEFAULT '2024-12-05T14:56:19.318Z' NOT NULL,
...
INSERT INTO `__new_bookings`("booking_id", "name", "email", "phone", "total_price", "id_manicurist", "start_time", "end_time", "payment_status", "created_at", "advance_amount", "status") SELECT "booking_id", "name", "email", "phone", "total_price", "id_manicurist", "start_time", "end_time", "payment_status", "created_at", "advance_amount", 'finished' AS "status" FROM `bookings`;--> statement-breakpoint
...
CREATE TABLE `__new_complaints` (
	...
	`email` text NOT NULL,
	`phone` text NOT NULL,
	`date` text DEFAULT '2024-12-05T14:56:19.328Z' NOT NULL,
...
CREATE TABLE `__new_tasks` (
	...
	`created_at` text DEFAULT '2024-12-05T14:56:19.324Z' NOT NULL,
