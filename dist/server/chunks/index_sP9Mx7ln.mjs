import { A as AstroError, x as i18nNoLocaleFoundInPath, v as appendForwardSlash, s as joinPaths, R as ResponseSentError, y as MiddlewareNoDataOrNextCalled, z as MiddlewareNotAResponse, G as GetStaticPathsRequired, B as InvalidGetStaticPathsReturn, C as InvalidGetStaticPathsEntry, H as GetStaticPathsExpectedParams, J as GetStaticPathsInvalidRouteParam, K as trimSlashes, P as PageNumberParamNotFound, Q as NoMatchingStaticPathFound, S as PrerenderDynamicEndpointPathCollide, T as ReservedSlotName, L as LocalsNotAnObject, U as PrerenderClientAddressNotAvailable, V as ClientAddressNotAvailable, W as StaticClientAddressNotAvailable, X as RewriteWithBodyUsed, Y as AstroResponseHeadersReassigned } from './astro/assets-service_Bo83bRde.mjs';
import { g as getActionQueryString, d as deserializeActionResult } from './shared_BgmuPqmk.mjs';
import './astro-designed-error-pages_CiH3qK2X.mjs';
import { t as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, x as renderSlotToString, z as renderJSX, A as chunkToString, B as isRenderInstruction, R as ROUTE_TYPE_HEADER, o as clientLocalsSymbol, p as clientAddressSymbol, C as ASTRO_VERSION, v as responseSentSymbol$1, E as renderPage, G as REWRITE_DIRECTIVE_HEADER_KEY, H as REWRITE_DIRECTIVE_HEADER_VALUE, I as renderEndpoint } from './astro/server_JOKs7Agn.mjs';
import 'clsx';
